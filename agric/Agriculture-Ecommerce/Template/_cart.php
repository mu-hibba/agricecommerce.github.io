                                            ...
                                            <!-- product qty -->
                                                <div class="qty d-flex pt-2">
                                                    <div class="d-flex font-rale w-25">
                                                        ...
                                                        <input type="text" data-id="<?php echo $item['item_id'];?>" class="qty_input border px-2 w-100 bg-light" disabled value="100" placeholder="100">
                                                    ...
                                                    <form method="post" class="px-2">
                                                        ...
                                                        <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger px-3 border-right bg-dark">Delete</button>
                                                    </form>
                            ...
                            <div class="col-sm-3">
                                <div class="sub-total border text-center mt-2">
                                    ...
                                    <div class="border-top py-4">
                                        ...
                                        <button type="submit" onclick="location.href = './thank.php';" class="btn btn-warning mt-3">Proceed to Buy</button>
                                    </div>
                                </div>
                            </div>
                            <!-- !subtotal section-->
